...
def getRankInfo(userID, gameMode):
    ...
    if position != None and position > 0:
        ...
        if aboveUs != None and len(aboveUs) > 0 and aboveUs[0].isdigit():
            ...
            if nextUsername != None and myScore != None and otherScore != None:
...
def updateCountry(userID, newScore, gameMode):
    ...
    if userUtils.isAllowed(userID):
        ...
        if country != None and len(country) > 0 and country.lower() != "xx":
